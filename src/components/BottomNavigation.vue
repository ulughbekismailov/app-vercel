...
const navItems = [
  { name: 'home', label: 'Shop', path: '/', icon: HomeIcon },
  { name: 'cart', label: 'Cart', path: '/cart', icon: CartIcon, badge: 'cart' },
  { name: 'profile', label: 'Profile', path: '/profile', icon: ProfileIcon }
];
